  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="category-card-icon owner-category-card__icon flex h-11 w-11 self-start items-center justify-center rounded-full border border-[#c7a852]/70 bg-[#1c1917]/55 backdrop-blur-sm">
          ...
          <div className="owner-category-card__lower text-start">
            ...
            <h3 className="category-card-title me-auto max-w-[90%] break-words font-serif text-3xl leading-[1.02] sm:text-4xl">
              {category.name}
            </h3>
